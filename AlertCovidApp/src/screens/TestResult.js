    ...
    return (
      <View style={styles.containerTestResult}>
        <Background></Background>
         <Title navigation= {navigation} textTitle={GeneralConstants.testResultsTitle} RouteGo={'HomeScreen'}/>
        <ScrollWhite/>
        <ButtonSave navigation={navigation} RouteGo={'HistoryTest'} textButton={GeneralConstants.save} />
